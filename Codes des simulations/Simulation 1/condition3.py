...
average_speed = (number_of_cycles * 2 * (WINDOW_WIDTH - BALL_SIZE * 2)) / total_duration
...
while running:
    ...
    if simulation_started:
        ...
        if current_time - start_time >= 1000:  # Démarrage du mouvement après 1 seconde
            speed_variation = random.uniform(-0.3, 0.3)  # Variation de vitesse entre -0.5 et 0.5 fois la vitesse moyenne
            ball_speed_x = average_speed
