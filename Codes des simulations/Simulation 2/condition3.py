...
while running:
    ...
    speed_variation = random.uniform(-0.5, 0.5)  # Variation de vitesse entre -0.5 et 0.5 fois la vitesse moyenne
    random_inter_blink = int(inter_blink_delay * (1 + speed_variation))
    pygame.time.wait(random_inter_blink)
